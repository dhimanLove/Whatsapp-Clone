...
class grps extends StatefulWidget {
  const grps({super.key});

  @override
  State<grps> createState() => _grpsState();
}

class _grpsState extends State<grps> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                  children: [
                    Text("Admins who can't add me to group will have the option of inviting you privately instead .", style: TextStyle(color: Colors.white54)),
                    SizedBox(height: 10),
                    Text("Setting ek aisi jagah aur samay hota hai jahan kahani ki ghatnaayein hoti hain. Yeh environment, mood aur character development mein madad karta hai, jo kahani ko zinda banata hai.", style: TextStyle(color: Colors.white54)),
                  ]
              ),
            ),
          ],
