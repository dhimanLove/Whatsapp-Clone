...
class Chatscreennine extends StatefulWidget {
  @override
  _ChatscreennineState createState() => _ChatscreennineState();
}

class _ChatscreennineState extends State<Chatscreennine> {
