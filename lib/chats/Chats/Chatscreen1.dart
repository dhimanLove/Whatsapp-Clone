...
class Chatscreentwoone extends StatefulWidget {
  @override
  _ChatscreentwooneState createState() => _ChatscreentwooneState();
}

class _ChatscreentwooneState extends State<Chatscreentwoone> {
