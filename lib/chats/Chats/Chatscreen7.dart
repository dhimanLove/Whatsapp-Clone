...
class Chatscreenseven extends StatefulWidget {
  @override
  _ChatscreensevenState createState() => _ChatscreensevenState();
}

class _ChatscreensevenState extends State<Chatscreenseven> {
