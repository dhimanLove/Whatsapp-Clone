          ...
          child: Column(
            children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          Container(
                              height: scrH*0.1,
                              child: Image.network("https://cdn.icon-icons.com/icons2/2785/PNG/512/receipt_icon_177352.png")),
                          SizedBox(height: scrH*0.01,),
              ...
              Container(
                ...
                child: ListTile(
                  leading: FaIcon(FontAwesomeIcons.bucket,color:Colors.white70),
                  title: Text("Remove payments information",style: TextStyle(color: Colors.white38,fontWeight:FontWeight.w300),),
                ),
              ),
              Container(
                  height: scrH*0.08,
                  child: Image.network("https://cdn.iconscout.com/icon/free/png-256/free-upi-logo-icon-download-in-svg-png-gif-file-formats--unified-payments-interface-payment-money-transfer-logos-icons-1747946.png?f=webp"))
            ],
          ),
        ),
      ),
