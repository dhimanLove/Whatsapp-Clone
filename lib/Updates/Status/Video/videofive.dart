...
class Videofive extends StatefulWidget {
  const Videofive({super.key});

  @override
  _VideofiveState createState() => _VideofiveState();
}

class _VideofiveState extends State<Videofive> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
      'https://cdn.pixabay.com/video/2023/08/22/177164-857004199_large.mp4',
    )..initialize().then((_) {
      setState(() {});
      _controller.play();
    });
