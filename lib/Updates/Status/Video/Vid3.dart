...
class Vidthree extends StatefulWidget {
  const Vidthree({super.key});

  @override
  _VidthreeState createState() => _VidthreeState();
}

class _VidthreeState extends State<Vidthree> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
      'https://cdn.pixabay.com/video/2023/07/12/171247-845081850_large.mp4',
    )..initialize().then((_) {
      setState(() {});
      _controller.play();
    });
